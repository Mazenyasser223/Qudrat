      ...
      <header className="bg-[#214C3A] dark:bg-gray-800 text-white border-b border-gray-700 dark:border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <nav className="flex items-center space-x-3 rtl:space-x-reverse">
            {/* Dark Mode Toggle Button - EXTREMELY Visible */}
            <button
              onClick={toggleDarkMode}
              className="relative p-3 rounded-lg bg-white hover:bg-white/90 dark:bg-gray-700 dark:hover:bg-gray-600 border-2 border-white dark:border-gray-600 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-white/50 shadow-xl hover:shadow-2xl transform hover:scale-110 z-10"
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card p-8 text-center bg-[#214C3A] dark:bg-gray-800 text-white border-none shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              ...
              <a href="/مذكرة_تبسيط_القدرات_مستر_علاء_وهبه.pdf" download="مذكرة_تبسيط_القدرات_مستر_علاء_وهبه.pdf" className="mt-4 inline-block px-6 py-3 rounded-lg bg-white text-[#214C3A] font-semibold hover:bg-gray-100 transition shadow-md">
            ...
            <div className="card p-8 text-center bg-[#214C3A] dark:bg-gray-800 text-white border-none shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              ...
              <a href="/قوانين القدرات (مستر علاء وهبه).pdf" download="قوانين القدرات (مستر علاء وهبه).pdf" className="mt-4 inline-block px-6 py-3 rounded-lg bg-white text-[#214C3A] font-semibold hover:bg-gray-100 transition shadow-md">
                <span className="flex items-center justify-center">
                  <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
            ...
            <div className="card p-8 text-center bg-[#214C3A] dark:bg-gray-800 text-white border-none shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              ...
              <a href="/تسميع قوانين.pdf" download="تسميع قوانين.pdf" className="mt-4 inline-block px-6 py-3 rounded-lg bg-white text-[#214C3A] font-semibold hover:bg-gray-100 transition shadow-md">
                <span className="flex items-center justify-center">
                  <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
